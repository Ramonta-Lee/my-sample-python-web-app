...
import { Vpc, SubnetType, Peer, Port, AmazonLinuxGeneration, AmazonLinuxCpuType, Instance, SecurityGroup, AmazonLinuxImage, InstanceClass, InstanceSize, InstanceType } from 'aws-cdk-lib/aws-ec2';
...
export class PythonEc2BlogStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Role that will be attached to the EC2 instance so that it can be managed by AWS SSM
    ...
    webSg.addIngressRule(
      ...
      const githubSourceAction = new GitHubSourceAction({
        ...
        owner: 'Ramonta-Lee', // This is where you put your Github user ID
        repo: 'my-sample-python-web-app',
        branch: 'main',
        output: sourceOutput,
      });
